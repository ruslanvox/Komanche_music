...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    ...
    $(window).scroll(function () {
      $(this).scrollTop() > o
        ? $(".scroll-top").fadeIn(t)
        : $(".scroll-top").fadeOut(t);
    }),
      $(".scroll-top").click(function (o) {
        return (
          o.preventDefault(), $("html, body").animate({ scrollTop: 0 }, t), !1
        );
      });
  });
/*!
  ...
  n.extend(s, {
    ...
    open: function (e, t) {
      return e && (n.isPlainObject(t) || (t = {}), !1 !== s.close(!0))
        ? (n.isArray(e) || (e = p(e) ? n(e).get() : [e]),
          n.each(e, function (o, a) {
            ...
            "object" === n.type(a) &&
              ...
              !d &&
                ...
                d ||
                  ((f = a.prop("class").match(/fancybox\.(\w+)/)),
                  (d = f ? f[1] : null))),
              h(r) &&
                (d ||
                  (s.isImage(r)
                    ...
                    : h(a) && ((d = "html"), (c = a))),
                "ajax" === d &&
                  ((u = r.split(/\s+/, 2)), (r = u.shift()), (g = u.shift()))),
              c ||
                ("inline" === d
                  ? r
          ...
          t.keys !== i &&
            (s.opts.keys = t.keys ? n.extend({}, s.defaults.keys, t.keys) : !1),
          (s.group = e),
    ...
    getViewport: function () {
      ...
      return (
        t && t.length
          ...
          : ((n.w = d && e.innerWidth ? e.innerWidth : a.width()),
            (n.h = d && e.innerHeight ? e.innerHeight : a.height())),
        n
      );
    },
    unbindEvents: function () {
    ...
    trigger: function (e, t) {
      ...
      if (o) {
        if (
          (n.isFunction(o[e]) &&
            (i = o[e].apply(o, Array.prototype.slice.call(arguments, 1))),
          i === !1)
        )
          return !1;
        o.helpers &&
    ...
    _loadIframe: function () {
      ...
      n(e.wrap).bind("onReset", function () {
        ...
        e.iframe.preload &&
          ...
          t.one("load", function () {
            n(this).data("ready", 1),
              d || n(this).bind("load.fb", s.update),
              n(this)
                .parents(".fancybox-wrap")
                .width("100%")
                .removeClass("fancybox-tmp")
    ...
    _setDimension: function () {
      ...
      if (
        (W.add(S)
          ...
          .height("auto")
          .removeClass("fancybox-tmp"),
        (e = g(S.outerWidth(!0) - S.width())),
        (t = g(S.outerHeight(!0) - S.height())),
        (i = I + e),
        (o = D + t),
        (a = f(T) ? ((w.w - i) * g(T)) / 100 : T),
        (r = f(_) ? ((w.h - o) * g(_)) / 100 : _),
        "iframe" === E.type)
      ) {
        if (((x = E.content), E.autoHeight && 1 === x.data("ready")))
          try {
            x[0].contentWindow.document.location &&
              (O.width(a).height(9999),
        ...
        (E.autoWidth || E.autoHeight) &&
          ...
          E.autoWidth || O.width(a),
          E.autoHeight || O.height(r),
          E.autoWidth && (a = O.width()),
          E.autoHeight && (r = O.height()),
      ...
      if (
        ...
        (l = P),
        (c = R),
        E.fitToView && ((P = Math.min(w.w - i, P)), (R = Math.min(w.h - o, R))),
        (u = w.w - I),
        (y = w.h - D),
        E.aspectRatio
          ? (T > P && ((T = P), (_ = g(T / d))),
            ...
            H > T && ((T = H), (_ = g(T / d))),
            L > _ && ((_ = L), (T = g(_ * d))))
          : ((T = Math.max(H, Math.min(T, P))),
            E.autoHeight &&
              "iframe" !== E.type &&
              (O.width(T), (_ = O.height())),
            (_ = Math.max(L, Math.min(_, R)))),
        E.fitToView)
      )
        if (
          (O.width(T).height(_),
          ...
          for (; (p > u || h > y) && T > H && _ > L && !(b++ > 19); )
            (_ = Math.max(L, Math.min(R, _ - 10))),
              (T = g(_ * d)),
              H > T && ((T = H), (_ = g(T / d))),
              T > P && ((T = P), (_ = g(T / d))),
              O.width(T).height(_),
          ...
          (T = Math.max(H, Math.min(T, T - (p - u)))),
            (_ = Math.max(L, Math.min(_, _ - (h - y))));
      M && "auto" === j && r > _ && u > T + e + M && (T += M),
        O.width(T).height(_),
        W.width(T + e),
        (p = W.width()),
        (h = W.height()),
    ...
    _getPosition: function (e) {
      ...
      return (
        t.autoCenter && t.fixed && !e && a <= n.h && o <= n.w
          ? (r.position = "fixed")
    ...
    (s.helpers.title = {
      ...
      beforeShow: function (e) {
        var t,
          ...
          r = e.type;
        if (
          (n.isFunction(a) && (a = a.call(o.element, o)),
          h(a) && "" !== n.trim(a))
        ) {
          switch (
            ((t = n(
